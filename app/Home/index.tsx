...
import MapView, { MapPolyline, Marker, PROVIDER_DEFAULT, PROVIDER_GOOGLE, Polyline } from "react-native-maps";
...
export default function Home() {
  ...
  return (
    <Container>
      ...
      <Text style={{fontFamily: "Plus-Jakarta-Sans"}}>Current user latitude: {location.coords.latitude}</Text>
      <Text style={{fontFamily: "Plus-Jakarta-Sans"}}>Current user longitude: {location.coords.longitude}</Text>
